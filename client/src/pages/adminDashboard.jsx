  ...
  return (
    <div className="flex min-h-screen bg-[#f8fafc]">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        <div className="mb-10">
          <h1 className="text-4xl font-[1000] text-slate-800 uppercase tracking-tight">
            System Overview
          </h1>
        ...
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-12 lg:col-span-8 space-y-10">
            ...
            <section>
              <div className="flex items-center gap-2 mb-6">
                <h3 className="font-black text-slate-800 uppercase text-xs tracking-[0.15em]">Quick Management Actions</h3>
              </div>
          ...
          <div className="col-span-12 lg:col-span-4">
            <div className="flex items-center gap-2 mb-6">
              <h3 className="font-black text-slate-800 uppercase text-xs tracking-[0.15em]">Live Activity Log</h3>
            </div>
            <LiveActivity />
          </div>
        </div>
